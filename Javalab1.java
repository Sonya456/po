...
public class Javalab1 {
 ...
 {
Punkt pierwszy=new Punkt(4,8);
System.out.println(pierwszy.getX());
System.out.println(pierwszy);
Punkt drugi=new Punkt(4,8);
System.out.println(pierwszy == drugi);
System.out.println(pierwszy.equals(drugi));

Punkt trzeci=new Punkt(2,1);
Transformacja tr2=new Obrot(3.14);
Punkt czwarty=tr2.transformuj(trzeci);
